...
<html>
<head>
    <title>Algoritma Knuth Morris Pratt</title>
...
<body>
    ...
    <h1 style="text-align: center; font-size: 32px; color: #8EDB15; padding-bottom: 25px;">Algoritma Knuth Morris Pratt</h1>
        <?php
        if (!empty($kata)) {
            ...
            <form method="get" action="">
                ...
                while ($teks = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    if (!empty($kata)) {
                        ...
                        echo "<p style='text-align: center; font-size: 13px; padding-bottom: 4px;'>Waktu Pencarian KMP: <span class='highlighted'> $search_execution_time_kmp seconds </span></p><br>";
                        echo "</div>";
